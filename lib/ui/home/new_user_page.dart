            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    homeController.emailController.text = user.name!;
                    homeController.companyController.text = user.job!;
                        ...
                        return UserForm(
                          ...
                          onSubmit: () async {
                            await homeController
                              ...
                              homeController.companyController.text,
                            )
                                .then((value) {
                  ...
                  trailing: user.updatedAt != null
                      ? Text(
                          DateFormat().format(DateTime.parse(user.updatedAt!)))
                      : Text(
